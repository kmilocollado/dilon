...
import { A as AstroError, E as EnvInvalidVariables } from './astro/server_RBOATzLn.mjs';

const schema = {"CONTENT_ISLAND_SECRET_TOKEN":{"context":"server","access":"secret","optional":false,"default":"INFORM_VALID_TOKEN","type":"string"}};
